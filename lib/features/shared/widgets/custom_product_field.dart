...
class CustomProductField extends StatelessWidget {
  ...
  final bool obscureText;                     // Indica si el texto de entrada debe estar oculto
  final TextInputType? keyboardType;
  final int maxLines;
  final String initialValue;
  final Function(String)? onChanged;          // Función que se llama cuando cambia el valor del campo de entrada
